...
const pages: Record<string, PageData> = {
  '/how-it-works': {
    ...
    intro: 'Comuta compares complete routes, timing, recurrence and trust context so riders and drivers can form carpools that work beyond a single journey.',
  ...
  '/safety': {
    ...
    intro: 'Comuta combines identity checks, vehicle review, trip controls and human operations so every safety signal has context and a clear owner.',
  ...
  '/drivers': {
    ...
    intro: 'Comuta helps verified drivers fill empty seats on scheduled routes, manage trusted passenger requests and receive transparent cost contributions.',
  ...
  '/about': {
    ...
    intro: 'Comuta is a Nigerian recurring carpool marketplace designed around verified people, constrained launch corridors and the journeys commuters make every week.',
    ...
    calloutTitle:'Experience the marketplace',calloutText:'Move between rider, driver and operations views to see how the system connects.',action:'Open Comuta',
  },
  '/help': {
  ...
  '/privacy': {
    ...
    intro: 'Comuta is designed to collect the information needed for matching, verification, payments and safety while keeping access controlled and accountable.',
  ...
  '/terms': {
    ...
    intro: 'Comuta members agree to provide accurate information, follow approved trip rules and use the marketplace for legitimate shared journeys.',
