...
const STORAGE_KEY = 'comuta.pwa.v2';
...
function notify(state: ComutaStore, userId: string, title: string, body: string, kind: AppNotification['kind']): AppNotification {
...
/** Actions helpers (re-exports so services don't need the store import). */
...
export type { DayIndex, TripStatus, Payment, PayoutRecord, Trip, Booking, RecurringRoute, User, AppNotification, Incident, SupportTicket, TrustedContact };
